...
def build_parser():
    import argparse
    parser = argparse.ArgumentParser(description="KA9Q Radio Hamlib-compatible rigctld server")
    parser.add_argument("mcast_group", nargs="?", default="hf.local")
    parser.add_argument("ssrc", nargs="?", type=int, default=DEFAULT_SSRC_ID)
    parser.add_argument("freq_hz", nargs="?", type=int, default=7078000)
